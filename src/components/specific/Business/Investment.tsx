...
function Investment({ }: Props) {
    ...
    return (
        <section className="mt-6 md:mt-20 flex justify-end flex-col-reverse md:flex-row items-center relative w-full">

            <Image
                alt={language === 'en' ? 'Technology. Real Estate. Invention.' : 'تكنولوجيا, العقارات, اختراع '}
                className='w-full max-w-[780px] mt-0 md:mt-0 rounded-[15px] h-[400px] object-cover'
                src={businessImage4}
            />

            <div className="bg-black pb-4 md:pb-0 pe-4 flex-col justify-center flex max-w-[650px] w-full md:h-[290px] md:absolute left-0 md:left-0 rounded-[15px]">
                <H2
