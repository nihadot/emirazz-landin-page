...
type HeadingType = 'type1' | 'type2' | 'type3' | 'type4' | 'type5' ;
  ...
  const getClassNames = (type: HeadingType): string => {
    switch (type) {
      ...
      case "type2":
        ...
        case "type3":
          return `${language === 'en' ? 'font-montserrat ' : 'font-almaraiLight'}  md:text-[45px] font-normal  md:leading-[70.02px] text-white text-[26px] leading-[31.61px]`; ///
          case "type4":
