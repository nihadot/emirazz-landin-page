...
function StrategicProcurement({ }: Props) {
  ...
  return (
    <section className='  flex justify-start md:flex-row pt-20 md:pt-40 md:gap-8 relative h-full px-4 md:px-10 lg:px-20  bg-black flex-col'>
      ...
      <div className="flex-1 items-center justify-center flex flex-col">
        ...
        <div className={`flex flex-col md:flex-col ${language === 'ar' && '!flex-col'}`}>
          ...
          {language === 'ar' && <Description
            className={`w-full ${language === 'ar' ? 'mb-6' : ''} `}
            type='type1'
